...
import typescript from "../assets/images/language/typescript.png";
...
const skillDetails = {
  frontend: [
    ...
    },
    {
      skill: "TypeScript",
      image: typescript,
      description: "Implement Static typing and improved maintainability."
    },
    {
      skill: "Figma",
      image: figma,
...
const projectDetails = [
  {
    ...
    technologies: [
      ...
      { icon: SiTypescript, style: "text-primary" },
